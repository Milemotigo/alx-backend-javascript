...
describe('calculateNumber', () => {
  ...
  describe('type == "DIVIDE"', () => {
    it('positive numbers', () => {
      expect(calculateNumber('DIVIDE', 8.0, 2.0)).to.be.equal('Error');
    });
    ...
    it('numbers with different signs (alternate)', () => {
      expect(calculateNumber('DIVIDE', 7.0, -2.0)).to.be.equal('Error');
    });
    ...
    it('0 and negative number', () => {
      expect(calculateNumber('DIVIDE', 0.0, -5.0)).to.be.equal('Error');
    });
    ...
    it('negative number and 0', () => {
      expect(calculateNumber('DIVIDE', -5.0, 0)).to.be.equal(-Infinity);
    });

    it('negative number and number rounded down to zero', () => {
      expect(calculateNumber('DIVIDE', -5.0, 0.2)).to.be.equal(-Infinity);
    });
    ...
    it('0 and 0', () => {
      expect(Number.isNaN(calculateNumber('DIVIDE', 0.0, 0.0))).to.equal(true);
    });
  });
});
